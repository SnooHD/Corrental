  ...
  if (document.getElementById("date_booking" + bk_type).value == "") {
    ...
    if (arr_of_selected_additional_calendars.length == 0) {
      wpbc_front_end__show_message__error_under_element(
        "#booking_form_div" + bk_type + " .bk_calendar_frame",
  ...
  for (var i = 0; i < count; i++) {
    ...
    if (
      ...
      if (jQuery(element).is(":visible")) {
        ...
        if (
          typeof wpbc__is_less_than_required__of_max_available_slots__bl ==
          "function"
        ) {
          if (
            wpbc__is_less_than_required__of_max_available_slots__bl(
              bk_type,
              element
            )
          ) {
...
function send_ajax_submit(
  ...
  var is_exit = wpbc_ajx_booking__create({
    ...
    dates_ddmmyy_csv: document.getElementById("date_booking" + resource_id)
      .value,
    formdata: formdata,
    ...
    aggregate_resource_id_arr:
      null !==
      _wpbc.booking__get_param_value(resource_id, "aggregate_resource_id_arr")
        ? _wpbc
            .booking__get_param_value(resource_id, "aggregate_resource_id_arr")
            .join(",")
        : "",
            ...
            if ("checkbox" == jQuery(el).attr("type")) {
              if (
                ...
                if (jQuery(el).parents(".wpdev-form-control-wrap").length > 0) {
                  checkbox_parent_element = jQuery(el).parents(
                ...
                var notice_message_id = wpbc_front_end__show_message__warning(
                  checkbox_parent_element,
                  message_verif_requred_for_check_box
                );
              ...
              if (
                ...
                var notice_message_id = wpbc_front_end__show_message__warning(
                  jQuery(el).parents(".wpdev-form-control-wrap"),
                  message_verif_requred_for_radio_box
                );
                fields_with_errors_arr.push(el);
                is_error_in_field = true; // Error
