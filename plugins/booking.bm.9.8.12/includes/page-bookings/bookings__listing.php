				...
				<div class="wpbc_listing_col wpbc_col_id check-column"><div class="content_text"><input type="checkbox" /></div></div>
					<div class="wpbc_listing_col wpbc_col_booking_labels wpbc_col_labels">
						<div class="content_text">
							...
							if(data.parsed_fields.coupon) {
								#>
									<span class="wpbc_label wpbc_label_coupon" style="background-color: #e06841;"><i style="color: #f6efe8;" class="menu_icon icon-1x wpbc_icn_discount"></i>{{{data.parsed_fields.coupon}}}</span>
								<#
							}
