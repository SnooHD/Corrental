...
function wpbc_show_thank_you_message_after_booking(response_data) {
  ...
  confirm_content += `        <div class="wpbc_ty__content_text wpbc_ty__payment_description ${ty_payment_payment_description_hide}">${response_data[
    "ajx_confirmation"
  ]["ty_payment_payment_description"].replace(/\\n/g, "")}</div>`;
  ...
  confirm_content += `        <div class="wpbc_ty__content_text wpbc_ty__content_gateways ${ty_payment_gateways_hide}">${response_data[
    "ajx_confirmation"
  ]["ty_payment_gateways"]
    .replace(/\\n/g, "")
    .replace(/ajax_script/gi, "script")}</div>`;
  confirm_content += `      </div>`;
  confirm_content += `    </div>`;
  confirm_content += `</div>`;
