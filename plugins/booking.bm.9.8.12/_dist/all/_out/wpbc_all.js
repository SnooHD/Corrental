...
var _wpbc = (function (obj, $) {
  ...
  var p_calendars = (obj.calendars_obj =
    obj.calendars_obj ||
    {
      // sort            : "booking_id",
      // sort_type       : "DESC",
  ...
  obj.calendar__set_parameters = function (resource_id, calendar_property_obj) {
    var is_complete_overwrite =
      arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : false;

    if (
      !obj.calendar__is_defined(resource_id) ||
      true === is_complete_overwrite
    ) {
    ...
    for (var prop_name in calendar_property_obj) {
      p_calendars["calendar_" + resource_id][prop_name] =
        calendar_property_obj[prop_name];
    }
  ...
  obj.calendar__set_param_value = function (
    resource_id,
    prop_name,
    prop_value
  ) {
  ...
  var p_bookings = (obj.bookings_obj =
    obj.bookings_obj ||
    {
      // calendar_1: Object {
      //						   id:     1
  ...
  obj.bookings_in_calendar__set_dates = function (resource_id, dates_obj) {
    ...
    if (is_complete_overwrite) {
      ...
      for (var prop_name in dates_obj) {
        p_bookings["calendar_" + resource_id]["dates"][prop_name] =
          dates_obj[prop_name];
      }
    }
  ...
  obj.bookings_in_calendar__get_for_date = function (
    resource_id,
    sql_class_day
  ) {
    if (
      ...
      "undefined" !== typeof p_bookings["calendar_" + resource_id]["dates"] &&
      "undefined" !==
        typeof p_bookings["calendar_" + resource_id]["dates"][sql_class_day]
    ) {
  ...
  obj.seasons__set = function (resource_id, dates_obj) {
    ...
    if (is_complete_overwrite) {
      ...
      for (var prop_name in dates_obj) {
        if (
          "undefined" === typeof p_seasons["calendar_" + resource_id][prop_name]
        ) {
          p_seasons["calendar_" + resource_id][prop_name] = [];
        }

        for (var season_name_key in dates_obj[prop_name]) {
          p_seasons["calendar_" + resource_id][prop_name].push(
            dates_obj[prop_name][season_name_key]
          );
        }
      }
    }
...
_wpbc = (function (obj, $) {
    ...
    if (p_balancer["in_process"].length) {
      ...
      for (var i in p_balancer["in_process"]) {
        if (
          ...
          removed_el = removed_el.pop();
          p_balancer["in_process"] = p_balancer["in_process"].filter(function (
            v
          ) {
            return v;
          }); // Reindex array
  ...
  obj.balancer__run_next = function () {
    ...
    if (p_balancer["wait"].length) {
      //FixIn: 9.8.10.1
      for (var i in p_balancer["wait"]) {
        removed_el = obj.balancer__remove_from__wait_list(
          p_balancer["wait"][i]["resource_id"],
          p_balancer["wait"][i]["function_name"]
        );
        break;
      }
    }
...
function wpbc_balancer__is_wait(params, function_name) {
  ...
  if ("undefined" !== typeof params["resource_id"]) {
    var balancer_status = _wpbc.balancer__init(
      params["resource_id"],
      function_name,
      params
    );
...
function wpbc_disable_time_fields_in_booking_form(resource_id) {
  ...
  var time_fields_obj_arr =
    wpbc_get__time_fields__in_booking_form__as_arr(resource_id); // 2. Get all selected dates in  SQL format  like this [ "2023-08-23", "2023-08-24", "2023-08-25", ... ]
...
function wpbc_intervals__is_intersected(interval_A, interval_B) {
  ...
  var is_intersected =
    ...
    Math.min(interval_A[1], interval_B[1]); // if ( 0 == is_intersected ) {
...
function wpbc_cal_days_select__range(resource_id, days_min, days_max) {
  ...
  _wpbc.calendar__set_param_value(
    ...
    "dynamic__days_min",
    parseInt(days_min)
  ); // Min. Number of days selection with 2 mouse clicks

  _wpbc.calendar__set_param_value(
    resource_id,
    "dynamic__days_max",
    parseInt(days_max)
  ); // Max. Number of days selection with 2 mouse clicks
...
function wpbc_calendar__load_data__ajx(params) {
  ...
  console.log(
    " == Before Ajax Send - calendars_all__get() == ",
    _wpbc.calendars_all__get()
  ); // Start Ajax
  ...
  jQuery
    .post(
      ...
      function (response_data, textStatus, jqXHR) {
        ...
        var ajx_post_data__resource_id =
          wpbc_get_resource_id__from_ajx_post_data_url(this.data);
        wpbc_balancer__completed(
          ajx_post_data__resource_id,
        ...
        if (_typeof(response_data) !== "object" || response_data === null) {
          ...
          if ("" === response_data) {
            response_data =
              "The server responds with an empty string. The server probably stopped working unexpectedly. <br>Please check your <strong>error.log</strong> in your server configuration for relative errors.";
        ...
        _wpbc.bookings_in_calendar__set_dates(
          response_data["resource_id"],
          response_data["ajx_data"]["dates"]
        ); // Bookings - Child or only single booking resource in dates

        _wpbc.booking__set_param_value(
          response_data["resource_id"],
          "resources_id_arr__in_dates",
          response_data["ajx_data"]["resources_id_arr__in_dates"]
        ); // Aggregate booking resources,  if any ?

        _wpbc.booking__set_param_value(
          response_data["resource_id"],
          "aggregate_resource_id_arr",
          response_data["ajx_data"]["aggregate_resource_id_arr"]
        ); // -------------------------------------------------------------------------------------------------
        // Update calendar
        ...
        if (
          "undefined" !==
            typeof response_data["ajx_data"]["ajx_after_action_message"] &&
          "" !=
          ...
          wpbc_front_end__show_message(
            ...
            ),
            {
              type:
                "undefined" !==
                typeof response_data["ajx_data"][
                  "ajx_after_action_message_status"
                ]
                  ? response_data["ajx_data"]["ajx_after_action_message_status"]
                  : "info",
              show_here: {
                jq_node: jq_node,
                where: "after",
        ...
        wpbc_calendar__loading__stop(response_data["resource_id"]);
        jQuery("body").trigger("wpbc_datepick_inline_calendar_done");
    ...
    .fail(function (jqXHR, textStatus, errorThrown) {
      ...
      if (jqXHR.status) {
        ...
        if (403 == jqXHR.status) {
          error_message +=
            '<br> Probably nonce for this page has been expired. Please <a href="javascript:void(0)" onclick="javascript:location.reload();">reload the page</a>.';
          error_message +=
            '<br> Otherwise, please check this <a style="font-weight: 600;" href="https://wpbookingcalendar.com/faq/request-do-not-pass-security-check/">troubleshooting instruction</a>.<br>';
        }
      }
...
function wpbc_get_calendar__jq_node__for_messages(ajx_post_data_url_params) {
  ...
  var calendar_resource_id = wpbc_get_resource_id__from_ajx_post_data_url(
...
function wpbc_get_resource_id__from_ajx_post_data_url(
  ...
  var calendar_resource_id = wpbc_get_uri_param_by_name(
    "calendar_request_params[resource_id]",
    ajx_post_data_url_params
  );
...
function wpbc_front_end__show_message(message) {
  ...
  if (params["type"] == "error") {
    ...
    message =
      '<i class="menu_icon icon-1x wpbc_icn_report_gmailerrorred"></i>' +
      message;
  }
  ...
  if (params["type"] == "success") {
    ...
    message =
      '<i class="menu_icon icon-1x wpbc_icn_done_outline"></i>' + message;
  }

  var scroll_to_element =
    '<div id="' + unique_div_id + '_scroll" style="display:none;"></div>';
  message =
    '<div id="' +
    unique_div_id +
    '" class="wpbc_front_end__message ' +
    params["css_class"] +
    '" style="' +
    params["style"] +
    '">' +
  ...
  if ("inside" === params["show_here"]["where"]) {
    ...
    jq_el_message = jQuery(params["show_here"]["jq_node"]).siblings(
      '[id^="wpbc_notice_"]'
    );
    ...
    jq_el_message = jQuery(params["show_here"]["jq_node"]).nextAll(
      '[id^="wpbc_notice_"]'
    );
    ...
    jq_el_message = jQuery(params["show_here"]["jq_node"])
      .nextAll(".wpbc_front_end__message_container_right")
      .find('[id^="wpbc_notice_"]');
    ...
    if (is_show_message) {
      ...
      jQuery(params["show_here"]["jq_node"]).after(
        '<div class="wpbc_front_end__message_container_right">' +
          message +
          "</div>"
      );
    }
    ...
    jq_el_message = jQuery(params["show_here"]["jq_node"])
      .siblings(".wpbc_front_end__message_container_left")
      .find('[id^="wpbc_notice_"]');
    ...
    if (is_show_message) {
      ...
      jQuery(params["show_here"]["jq_node"]).before(
        '<div class="wpbc_front_end__message_container_left">' +
          message +
          "</div>"
      );
    }
...
function wpbc_front_end__show_message__error_under_element(
  jq_node,
  message,
  message_delay
) {
...
function wpbc_front_end__show_message__error_above_element(
  jq_node,
  message,
  message_delay
) {
