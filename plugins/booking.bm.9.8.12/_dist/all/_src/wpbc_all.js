...
var _wpbc = (function (obj, $) {
   ...
   */
  obj.calendar__set_parameters = function (
    resource_id,
   ...
   */
  obj.bookings_in_calendar__set_dates = function (
    resource_id,
    dates_obj,
 ...
 * @array week_days__start		- [-1] | [ 1, 5]   		--  { -1 - Any | 0 - Su,  1 - Mo,  2 - Tu, 3 - We, 4 - Th, 5 - Fr, 6 - Sat }
 */
function wpbc_cal_ready_days_select__range(
  resource_id,
  days_min,
  days_max,
  days_specific = [],
 ...
 * @array week_days__start		- [-1] | [ 1, 5]   		--  { -1 - Any | 0 - Su,  1 - Mo,  2 - Tu, 3 - We, 4 - Th, 5 - Fr, 6 - Sat }
 */
function wpbc_cal_days_select__range(
  resource_id,
  days_min,
  days_max,
  days_specific = [],
