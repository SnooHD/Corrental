...
function wpbc_make_save_custom_booking_form() {
	...
	if ( wpbc_is_this_demo() ) {																						//FixIn: 9.7.3.3.1
		$booking_form      = wp_kses_post( $booking_form );
		$booking_form_show = wp_kses_post( $booking_form_show );
                ...
                ?><div class="control-group wpbc-no-padding" style="margin:8px 15px 0 0;"><?php 
                    ?><a href="javascript:void(0);" 
                        ...
                        style="margin:0 15px 0 0;"
                         class="button button-primary tooltip_top" data-original-title="<?php _e('Create dates filter' , 'booking'); ?>">
