...
class WPBC_Page_Settings__seasonfilters extends WPBC_Page_Structure {
    ...
    private function css() {
        ...
        <style type="text/css">  
			...
			.wpbc_sf_section_selectable  .wpbc_row .check-column{
				margin: 0px 3px 5px;
			}
			#create_filter_conditional_new_metabox .wpbc_row .check-column,
			#create_filter_conditional_new_metabox .wpbc_row .check-column label,
			.wpbc_sf_section_selectable .wpbc_row .check-column,
			.wpbc_sf_section_selectable .wpbc_row .check-column label{
				position:relative;
				display: inline-flex;
				...
				/* Exception  for Conditional Y | M | Weekdays */
				#create_filter_conditional_new_metabox .sfd_weekday .wpbc_row .check-column label,
				#create_filter_conditional_new_metabox .sfd_months .wpbc_row .check-column label,
				#create_filter_conditional_new_metabox .sfd_years .wpbc_row .check-column label,
				.wpbc_sf_section_selectable.sfd_weekday .wpbc_row .check-column label,
				.wpbc_sf_section_selectable.sfd_months .wpbc_row .check-column label,
				.wpbc_sf_section_selectable.sfd_years .wpbc_row .check-column label
				{
					flex-flow: row wrap;
					align-items: flex-start;
				}
				#create_filter_conditional_new_metabox .sfd_weekday .wpbc_row .check-column label input,
				#create_filter_conditional_new_metabox .sfd_months .wpbc_row .check-column label input,
				#create_filter_conditional_new_metabox .sfd_years .wpbc_row .check-column label input,
				.wpbc_sf_section_selectable.sfd_weekday .wpbc_row .check-column label input,
				.wpbc_sf_section_selectable.sfd_months .wpbc_row .check-column label input,
				.wpbc_sf_section_selectable.sfd_years .wpbc_row .check-column label input
				{
					margin-right:0.5em;
				}
            #create_filter_conditional_new_metabox .wpbc_row .check-column label,
            ...
            .wpbc_sf_section_selectable .wpbc_row .check-column label input{
                margin:5px 0 0;
            }
			.wpbc_sf_section_selectable .wpbc_row .check-column label:hover,
			.wpbc_sf_section_selectable .wpbc_row .check-column input:hover + label {
				background: initial;
			}
            .wpbc_sf_section_selectable .wpbc_selectable_body .wpbc_row .check-column .day_num{
                font-size: 14px;
                font-weight: 600;
                margin-bottom: 3px;
            }
			...
			.wpbc_sf_section_selectable .wpbc_selectable_head {
				flex: 0 0 100px;
				padding: 0;
				margin: 0;
			}
			...
			.season_current_date {
				...
				text-decoration-color: #5f24b5;
			}

			/* FixIn: 9.8.6.3 */
			.weekdays_selection_container .wpbc_sf_section_selectable .wpbc_row .check-column label {
				display: flex;
				flex-flow: row wrap;
				align-items: center;
				padding: 0;
			...
			.weekdays_selection_container .wpbc_sf_section_selectable .wpbc_row .check-column label input {
				margin: 0 0.35em 0 0;
			}
			.weekdays_selection_container {
			  background: #f9f9f9;
			  padding: 0 1em;
			...
			.weekdays_selection_container .wpbc_selectable_table  {
			  border:none;
			  font-weight:400;
			}
			.weekdays_selection_container .wpbc_selectable_table .wpbc_row {
			  margin:0;
			}
			.weekdays_selection_container .wpbc_sf_section_selectable {
			  justify-content: flex-start;
			}
			.weekdays_selection_container .wpbc_sf_section_selectable .wpbc_selectable_body {
			  flex:0 1 auto;
			}
        </style>
        <?php
    ...
    private function enqueue_js(){                                                        
        ...
        // Weekdays selection  click //FixIn: 9.8.6.3
        $js_script .= " jQuery('input[type=\'checkbox\'].select_weekday').on( 'change', function(){
        					var is_checked = jQuery(this).is(':checked');            
        					var checkbox_label_container = jQuery( this ).closest('.visibility_container').filter(':visible').find( '.check-column.weekday'+jQuery( this ).val() );
							var checkboxes = checkbox_label_container.find(':checkbox').filter(':visible');       
        					checkboxes.prop('checked',is_checked);
        					if (is_checked){
        						checkbox_label_container.addClass('wpbc_checkbox_selected');
        					} else {
        						checkbox_label_container.removeClass('wpbc_checkbox_selected');
        					}
						} ); ";
        ...
        */
        ...
        ?><div class="wpbc_selectable_table wpbc_sf_section_selectable <?php echo $name_elmnt; ?>">
            ...
            ?><div class="wpbc_selectable_body"><?php
                ...
                <div class="wpbc_row">
                    <div class="check-column">
                        <label for="<?php echo $name_elmnt; ?>_<?php echo $i_el; ?>" class="wpbc-form-checkbox<?php if ( date_i18n( "w") ==  $i_el ) { echo ' season_current_date '; } ?>" >
                            <input type="checkbox" autocomplete="off" value="Off" 
        ...
        */
        ...
        ?><div class="wpbc_selectable_table wpbc_sf_section_selectable <?php echo $name_elmnt; ?>">
            ...
            ?><div class="wpbc_selectable_body"><?php
                ...
                <div class="wpbc_row">
                    <div class="check-column">
                        <label for="<?php echo $name_elmnt; ?>_<?php echo $i_el; ?>" class="wpbc-form-checkbox<?php if ( date_i18n( "d") ==  $i_el ) { echo ' season_current_date '; } ?>" >
                            <input type="checkbox" autocomplete="off" value="Off" 
        ...
        */
        ...
        ?><div class="wpbc_selectable_table wpbc_sf_section_selectable <?php echo $name_elmnt; ?>">
            ...
            ?><div class="wpbc_selectable_body"><?php
                ...
                <div class="wpbc_row">
                    <div class="check-column">
                        <label for="<?php echo $name_elmnt; ?>_<?php echo $i_el; ?>" class="wpbc-form-checkbox<?php if ( date_i18n( "m") ==  $i_el ) { echo ' season_current_date '; } ?>"  >
                            <input type="checkbox" autocomplete="off" value="Off" 
        ...
        */
        ...
        ?><div class="wpbc_selectable_table wpbc_sf_section_selectable <?php echo $name_elmnt; ?>">
            ...
            ?><div class="wpbc_selectable_body"><?php
                ...
                <div class="wpbc_row">
                    <div class="check-column">
                        <label for="<?php echo $name_elmnt; ?>_<?php echo $i_el; ?>" class="wpbc-form-checkbox<?php if ( date_i18n( "Y") ==  $i_el ) { echo ' season_current_date '; } ?>" >
                            <input type="checkbox" autocomplete="off" value="Off" 
        ...
        <a href="javascript:void(0);" class="button wpbc-reset-button"  
           onclick="javascript:var checkbox_label_container = jQuery(this).closest('form').filter(':visible').find('.check-column');
								   checkbox_label_container.find(':checkbox').prop('checked',false);
								   checkbox_label_container.removeClass('wpbc_checkbox_selected');"
            ><?php _e('Reset All', 'booking'); ?></a>
        <?php            
    }
                    ...
                    for ( $yy = ( date_i18n( 'Y') - 1 ); $yy < ( date_i18n( 'Y') + 10 ); $yy++ ) {
                        ...
                        wpbc_bs_display_tab(   array(
                                                        ...
                                                        , 'onclick'     =>    "jQuery('.wpbc_season_filter__range_days .visibility_container').hide();"
                                                                            . "jQuery('.wpbc_season_filter__range_days .sf_container_' + jQuery(this).attr('tab_year')  ).show();"
...
//                                                                                )
            ...
            for ( $yy = ( date_i18n( 'Y') - 1 ); $yy < ( date_i18n( 'Y') + 10 ); $yy++ ) {
                ?><div class="visibility_container clearfix-height sf_container_<?php echo $yy; ?>" style="display:<?php echo ( $yy == date_i18n( 'Y') ) ? 'block' : 'none'  ?>;margin-top:-5px;"><?php 
                	...
                	$this->season_weekdays_selection( $yy );
	...
	//FixIn: 9.8.6.3
	function season_weekdays_selection( $yy ){

		?><div class="weekdays_selection_container"><?php

			$html_prefix = 'weekdays_selection';
			$name_elmnt = $html_prefix . 'weekday';
			$elmnt_arr = array(   __('Sunday' ,'booking')
								, __('Monday' ,'booking')
								, __('Tuesday' ,'booking')
			...
			?><div class="wpbc_selectable_table wpbc_sf_section_selectable <?php echo $name_elmnt; ?>"><?php

				?>
				<div class="wpbc_selectable_head">
					<div class="check-column">
						<label for="<?php echo $name_elmnt; ?>_all" class="wpbc-form-checkbox">
							<?php _e( 'Selection', 'booking' ); ?>
						</label>
					</div>
				</div>
				<?php
				...
				?><div class="wpbc_selectable_body"><?php
					...
					<div class="wpbc_row">
						<div class="check-column">
							<label for="<?php  echo $name_elmnt . '_' . $yy . '_' . $i_el; ?>" class="wpbc-form-checkbox" >
								<input type="checkbox" autocomplete="off"
									   value="<?php echo ( 0 === $i_el ) ? 7 : $i_el; ?>"
									   class="select_weekday select_weekday<?php echo ( 0 === $i_el ) ? 7 : $i_el; ?>"
									   name="<?php echo $name_elmnt . '_' . $yy . '_' . $i_el; ?>"
									   id="<?php   echo $name_elmnt . '_' . $yy . '_' . $i_el; ?>"/><?php
									echo $title_el; ?>
							</label>
						</div>
					</div>
					...
					<div class="wpbc_row">
						<div class="Filter">
					        <a href="javascript:void(0);" class="button wpbc-reset-button"
           						onclick="var checkbox_label_container = jQuery(this).closest('.visibility_container').filter(':visible').find('.check-column');
										 checkbox_label_container.find(':checkbox').filter(':visible').prop('checked',false);
										 checkbox_label_container.removeClass('wpbc_checkbox_selected');"
            				><?php _e('Reset', 'booking'); echo ' ' . $yy; ?></a>
					        <a href="javascript:void(0);" class="button wpbc-reset-button"
           						onclick="var checkbox_label_container = jQuery(this).closest('.visibility_container').filter(':visible').find('.check-column');
										 checkbox_label_container.find(':checkbox').filter(':visible').prop('checked',true);
										 checkbox_label_container.addClass('wpbc_checkbox_selected');"
            				><?php _e('Select', 'booking'); echo ' ' . $yy; ?></a>
						</div>
					</div>
					<?php
