...
class Calendar extends Element {
	...
	public function set_controls() {
		...
		$this->controls['calendar_days_trace_color'] = [
			...
			'css'   => [
				[
					'property' => 'color',
					'selector' => '.jet-booking-calendar tbody div.valid.day.checked',
				],
				[
					'property' => 'color',
					'selector' => '.jet-booking-calendar tbody div.valid.day.hovering',
				],
				[
					'property' => 'color',
					'selector' => '.jet-booking-calendar tbody div.valid.day.has-tooltip:hover',
				]
			],
		];
		...
		$this->controls['calendar_days_trace_bg_color'] = [
			...
			'css'   => [
				...
				[
					'property' => 'background-color',
					'selector' => '.jet-booking-calendar tbody div.valid.day.hovering.has-tooltip:hover',
				]
			]
		];
	...
	public function enqueue_scripts() {
		jet_abaf()->engine_plugin->enqueue_deps( get_the_ID() );
	}
