...
trait Check_In_Out_Render_Trait {
	...
	public function field_template() {
		...
		$options = jet_abaf()->tools->get_field_default_value( $default_value, $field_format, $this->get_queried_post_id() );

		jet_abaf()->engine_plugin->enqueue_deps( $this->get_queried_post_id() );
