			...
			<template v-if="! isSet || isReset">
				<template v-if="! currentStep">
					...
					<div class="jet-content__body">
						<div
							:class="[ 'jet-radio-item',  { 'active': 'plain' === bookingMode } ]"
							@click="bookingMode = 'plain'"
						>
							<cx-vui-radio
								:options-list="[
								{
						...
						<div>
							<div
								:class="[ 'jet-radio-item',  { 'active': 'wc_based' === bookingMode, 'disabled': ! hasWoocommerce } ]"
								@click="bookingMode = 'wc_based'"
							>
								<cx-vui-radio
									:options-list="[
										{
					...
					<div class="jet-content__actions">
						<cx-vui-button button-style="accent" :loading="loading" @click="selectMode()">
							<template slot="label">
				...
				<template v-if="1 === currentStep">
					<div class="jet-content__heading">
						...
						<p class="jet-content__heading-desc">
							<?php _e( 'Select a Custom Post Type (CPT) for the booking instance. For instance, the "Apartments" Post Type is for apartment bookings and the "Cars" CPT is for car bookings. Create a CPT using JetEngine.', 'jet-booking' ); ?>
						</p>
					</div>
				...
				<template v-if="4 < currentStep">
					...
					<div class="jet-content__heading">
						...
						<p class="jet-content__heading-desc">
							<?php _e( 'These are all settings you configured during the setup. You can adjust them in the Booking Settings if needed. Please remember yo can disable Setup Wizard in the <b>Booking Settings</b> > <b>Advanced tab</b>.', 'jet-booking' ); ?>
						</p>
					</div>

					<div class="jet-content__body wide">
						<div class="main">
							<template v-if="'plain' === bookingMode">
								<div class="cx-vui-component cx-vui-component--equalwidth">
									<div class="cx-vui-component__meta">
										<label class="cx-vui-component__label">
