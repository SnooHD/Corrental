...
Booking Calendar - first and most popular WordPress booking plugin. Easily manage full-day / time bookings in awesome, modern booking system.

== Description ==

= The #1 must have Booking Plugin for WordPress =

The original [Booking Calendar](https://wpbookingcalendar.com/ "WP Booking Calendar") is the first and most popular booking plugin for WordPress, downloaded by millions of users.

Plugin provides an **easy-to-use** awesome booking system for displaying **calendar availability**, receive bookings from your website visitors, and manage bookings through a **modern and clean booking admin panel**.
...
[Overview](https://wpbookingcalendar.com/overview/ "Features Overview of Booking Calendar") | [Demos](https://wpbookingcalendar.com/demo/ "Live demos of premium versions") | [FAQ](https://wpbookingcalendar.com/FAQ/ "Booking Calendar - FAQ") | [Video Guides](https://wpbookingcalendar.com/help/ "Youtube Video Tutorials") | [Get Support](https://wpbookingcalendar.com/support/ "Get support for Booking Calendar plugin" )

= Perfect solution for any booking logic =

As the first booking system for WordPress, we have developed a huge number of features to match your specific booking logic.

Easily **define available dates** and allow your visitors to **reserve** your property or service for a **full day** or **time-slot**.

Or extend functionality with premium versions to an advanced system for multiple resources with **seasonal prices**, rules for **conditional dates** selection, **search availability**, and much more, up to **multi-user system** where users can manage their **own availability independently**, similar to an Airbnb portal.
...
> Please note that this video showcases the functionality of a **legacy version** of the plugin. To see the updated, modern interface of Booking Calendar, please **check screenshots** below.
...
= Features overview in premium versions of Booking Calendar =
[youtube https://www.youtube.com/watch?v=HL6bqT8Ns58&list=PLabuVtqCh9dwNZgeEmghr1PkbLMMM-BpV&rel=0]
> Advanced **features in premium versions**. This video showcases the functionality of a **legacy versions** of the plugin. To see the updated functionality test live [demos](https://wpbookingcalendar.com/demo/)
...
- [Capacity and Availability](https://wpbookingcalendar.com/overview/#capacity) - set the  the maximum number of bookings that can be made per full day in calendar, and ensure that dates in the calendar are only available until the capacity is reached.
...
- English
- Greek 99.49% [ 1961 / 1971 ], fuzzy 5, not translated 5
- Turkish 98.22% [ 1936 / 1971 ], fuzzy 25, not translated 10
- Portuguese (Brazil) 97.11% [ 1916 / 1973 ], fuzzy 35, not translated 22
- French (France) 90.87% [ 1791 / 1971 ], fuzzy 125, not translated 55
- German 90.78% [ 1791 / 1973 ], fuzzy 127, not translated 55
- Romanian 89.14% [ 1757 / 1971 ], fuzzy 144, not translated 70
- Arabic 88.79% [ 1750 / 1971 ], fuzzy 150, not translated 71
- Finnish 88.58% [ 1746 / 1971 ], fuzzy 154, not translated 71
- Spanish (Mexico) 88.48% [ 1744 / 1971 ], fuzzy 156, not translated 71
- Dutch 88.34% [ 1743 / 1973 ], fuzzy 162, not translated 68
- Swedish 87.92% [ 1733 / 1971 ], fuzzy 159, not translated 79
- Spanish (Spain) 87.52% [ 1725 / 1971 ], fuzzy 165, not translated 81
- Norwegian 87.47% [ 1724 / 1971 ], fuzzy 167, not translated 80
- Polish 87.21% [ 1719 / 1971 ], fuzzy 168, not translated 84
- Slovenian 86.2% [ 1699 / 1971 ], fuzzy 179, not translated 93
- Hungarian 86.06% [ 1698 / 1973 ], fuzzy 181, not translated 94
- Italian 84.12% [ 1658 / 1971 ], fuzzy 200, not translated 113
- Danish 82.09% [ 1618 / 1971 ], fuzzy 228, not translated 125
- Bulgarian 82.04% [ 1617 / 1971 ], fuzzy 226, not translated 128
- Chinese (Taiwan) 80.31% [ 1583 / 1971 ], fuzzy 281, not translated 107
- Russian 78.56% [ 1550 / 1973 ], fuzzy 271, not translated 152
- Portuguese (Portugal) 77.93% [ 1536 / 1971 ], fuzzy 281, not translated 154
- Galician 77.83% [ 1534 / 1971 ], fuzzy 286, not translated 151
- Thai 77.78% [ 1533 / 1971 ], fuzzy 281, not translated 157
- Hebrew 75.44% [ 1487 / 1971 ], fuzzy 291, not translated 193
- Chinese (China) 74.73% [ 1473 / 1971 ], fuzzy 295, not translated 203
- Ukrainian 74.71% [ 1474 / 1973 ], fuzzy 300, not translated 199
- Croatian 64.18% [ 1265 / 1971 ], fuzzy 285, not translated 421
- Slovak 64.13% [ 1264 / 1971 ], fuzzy 287, not translated 420
- Czech 64.08% [ 1263 / 1971 ], fuzzy 286, not translated 422
- Catalan 63.93% [ 1260 / 1971 ], fuzzy 286, not translated 425
- Belarusian 8.57% [ 169 / 1971 ], fuzzy 863, not translated 939
...
== Screenshots ==
1. **Calendar Availability**. Super easily set available/unavailable dates in the calendar with 3 mouse clicks.
2. **Booking Listing**. You can easily manage all your bookings in one place by searching bookings by keyword, dates, status, and other parameters.
3. **Booking Listing** panel provides a smooth user experience by working instantly without page refresh.
4. **Calendar Overview**. Get a clear overview of all your bookings for the year in an intuitive interface, with fast action buttons.
5. **Add New Bookings.** Quickly create new bookings directly from your admin panel.
6. **Settings**. Configure the plugin to your specific requirements by adjusting different parameters.
7. **Form fields**. Customize your booking form by adding new fields or modifying existing ones, and define form structure to match your website's style.
8. **Emails**. Customize email templates for sending automatic notifications to both you and your customers about booking creation, approval, cancellation, and more.
9. **Sync**. Keep your bookings in sync with other platforms by configuring import/export through .ics feeds (iCal) to third-party services like Google Calendar, Airbnb, booking.com, and more.
10. **Insert Booking Calendar to a page**. Easily insert the booking form on any page of your website using WordPress blocks or Booking Calendar widgets for sidebars or configure shortcode block in page builders like Elementor.
11. **Front-End Booking Form**. Display available dates in a calendar and enable customers to book with a front-end booking form.
12. **Calendar Skins**. Choose the appearance of your booking calendar to match your website's theme design.
...
== Upgrade Notice ==
= 9.7 =
2 new calendar skins. Code refactoring and many improvements.