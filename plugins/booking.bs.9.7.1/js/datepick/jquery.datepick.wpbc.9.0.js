...
(function ($) {
  ...
  $.extend(Datepick.prototype, {
    ...
    _doHover: function (td, id, year, month) {
      ...
      var date = year
        ? this._daylightSavingAdjust(
            new Date(year, month, $(td).find(".active").text())
          )
        : null;
    ...
    _selectDay: function (td, id, timestamp) {
      ...
      if (rangeSelect && !inst.stayOpen) inst.dates[1] = date;
      else if (multiSelect) {
        var pos = -1;
    ...
    _generateHTML: function (inst) {
      ...
      var prev =
        ...
        (this._canAdjustMonth(inst, -1, drawYear, drawMonth)
          ? (showBigPrevNext
              ? "<div onclick=\"jQuery.datepick._adjustDate('#" +
                inst.id +
                "', -" +
                stepBigMonths +
                ", 'M');\"" +
            ...
            for (var dow = 0; dow < 7; dow++) {
              ...
              html +=
                ...
                (unselectable
                  ? ""
                  : ' onmouseover="' +
                    "jQuery.datepick._doMouseOver(this,'" +
                    inst.id +
                    "'," +
                    printDate.getTime() +
                    ')"' +
              ...
              html +=
                ...
                (empty
                  ...
                  : '<div class="active">' + printDate.getDate() + "</div>") +
