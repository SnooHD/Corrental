(function ($) {
  ...
  ApusThemeCore.prototype = {
    ...
    init: function () {
      ...
      $(".navbar-wrapper .show-navbar-sidebar").on("click", function () {
        $(this)
          .closest(".navbar-wrapper")
          .find(".navbar-sidebar-wrapper")
          .addClass("active");
        $(this)
          .closest(".navbar-wrapper")
          .find(".navbar-sidebar-overlay")
          .addClass("active");
      });

      $(".close-navbar-sidebar, .navbar-sidebar-overlay").on(
        "click",
        function () {
          $(this)
            .closest(".navbar-wrapper")
    ...
    initSlick: function (element) {
      ...
      element.each(function () {
        var config = {
          ...
          slidesToScroll: 4,
          prevArrow:
            "<button type='button' class='slick-arrow slick-prev'><i class='flaticon-left-arrow'></i></span><span class='textnav'>" +
            nerf_opts.previous +
            "</span></button>",
          nextArrow:
            "<button type='button' class='slick-arrow slick-next'><span class='textnav'>" +
            nerf_opts.next +
            "</span><i class='flaticon-right-arrow'></i></button>",
        };
        var slick = $(this);
        if ($(this).data("items")) {
        ...
        if ($(this).data("slidestoscroll_smalldesktop")) {
          var slidestoscroll_smalldesktop = $(this).data(
            "slidestoscroll_smalldesktop"
          );
        } else {
    ...
    imageHotspot: function () {
      $(".widget-image-hotspot.default, .widget-image-hotspot.style1").each(
        function () {
          $(this)
            .find(".drag_element")
            .mouseenter(function () {
              ...
              $(this)
                .closest(".widget-image-hotspot")
                .find(".wrap_svl_content .image-hotspot-point")
                .removeClass("active");
              $(this)
                .closest(".widget-image-hotspot")
                .find(".wrap_svl_content #" + content_id)
                .addClass("active");
            });
        }
      );
    ...
    initMobileMenu: function () {
      ...
      $("body").on(
        "click",
        ".mobile-sidebar-panel-overlay, .close-sidebar-btn",
        function () {
      ...
      $(window).scroll(function () {
        if ($("#wpadminbar").length) {
          var scroll_h = $("#wpadminbar").outerHeight();
        } else {
          var scroll_h = 0;
        }
        if ($(this).scrollTop() > scroll_h) {
          $("#apus-header-mobile").addClass("stick-header-mobile");
        } else {
          $("#apus-header-mobile").removeClass("stick-header-mobile");
        }
      });
    },
    mainMenuInit: function () {
      $(".apus-megamenu .megamenu .has-mega-menu.aligned-fullwidth").each(
        function (e) {
          var $this = $(this),
    ...
    initVerticalMenu: function () {
      ...
      $("#vertical-menu-layout1 .has-submenu > .icon-toggle").on(
        "click",
        function (e) {
          e.stopPropagation();
    ...
    changePaddingTopContent: function () {
      ...
      if ($(window).width() >= 1200) {
        ...
        $("body.single-post #apus-main-content").css({ "padding-top": 0 });
        ...
        if ($("#apus-header").length) {
          $(".header_transparent #apus-header").css({ top: admin_bar_h });
        }

        if ($("body.header_transparent .apus-breadscrumb").length) {
          $("body.header_transparent .apus-breadscrumb .wrapper-breads").css({
            "padding-top": admin_bar_h + header_h + 200 + "px",
          });
        }

        if ($(".apartment-heading.has-img").length) {
          $(".apartment-heading.has-img").css({
            "padding-top": header_h + 220 + "px",
          });
        }

        if ($(".page-404").length) {
          $(".page-404").css({ "padding-top": header_h });
        }
        ...
        $("body.single-post #apus-main-content").css({
          "padding-top": header_h,
        });

        if ($("body.header_transparent .apus-breadscrumb").length) {
          $("body.header_transparent .apus-breadscrumb .wrapper-breads").css({
            "padding-top": admin_bar_h + header_h + 30 + "px",
          });
        }
        if ($(".apartment-heading.has-img").length) {
          $(".apartment-heading.has-img").css({
            "padding-top": header_h + 50 + "px",
          });
        }
      ...
      if ($(window).width() >= 1200) {
        if ($("#apus-header").length) {
          $(".main-page-sidebar .sidebar-wrapper").css({
            top: $("#apus-header").outerHeight() + admin_bar_h,
          });
        }
      } else {
  ...
  jQuery(window).on("elementor/frontend/init", function () {
    ...
    elementorFrontend.hooks.addAction(
      "frontend/element_ready/apus_element_brands.default",
      function ($scope) {
    ...
    elementorFrontend.hooks.addAction(
      "frontend/element_ready/apus_element_features_box.default",
      function ($scope) {
        apusthemecore_init.initSlick($scope.find(".slick-carousel"));
      }
    );
    ...
    elementorFrontend.hooks.addAction(
      "frontend/element_ready/apus_element_posts.default",
      function ($scope) {
        apusthemecore_init.initSlick($scope.find(".slick-carousel"));
      }
    );
    ...
    elementorFrontend.hooks.addAction(
      "frontend/element_ready/apus_element_testimonials.default",
      function ($scope) {
        apusthemecore_init.initSlick($scope.find(".slick-carousel"));
      }
    );
    ...
    elementorFrontend.hooks.addAction(
      "frontend/element_ready/apus_element_banners.default",
      function ($scope) {
        apusthemecore_init.initSlick($scope.find(".slick-carousel"));
      }
    );
    ...
    elementorFrontend.hooks.addAction(
      "frontend/element_ready/apus_element_gallery.default",
      function ($scope) {
        apusthemecore_init.initSlick($scope.find(".slick-carousel"));
    ...
    elementorFrontend.hooks.addAction(
      "frontend/element_ready/apus_element_apartments.default",
      function ($scope) {
        apusthemecore_init.initSlick($scope.find(".slick-carousel"));
        apusthemecore_init.layzyLoadImage();
      }
    ...
    elementorFrontend.hooks.addAction(
      "frontend/element_ready/apus_element_amenities.default",
      function ($scope) {
        apusthemecore_init.initSlick($scope.find(".slick-carousel"));
        apusthemecore_init.layzyLoadImage();
      }
