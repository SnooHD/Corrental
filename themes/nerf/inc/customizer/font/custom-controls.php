<?php
/**
 * Nerf Customizer Custom Controls
 *
 */

if ( class_exists( 'WP_Customize_Control' ) ) {
	
	class Nerf_Google_Font_Select_Custom_Control extends WP_Customize_Control {
		/**
		...
		public function enqueue() {
			wp_enqueue_script( 'nerf-select2-js', get_template_directory_uri() . '/inc/customizer/js/select2.full.min.js', array( 'jquery' ), '4.0.13', true );
			wp_enqueue_script( 'nerf-customizer', get_template_directory_uri() . '/inc/customizer/js/customizer.js', array( 'nerf-select2-js' ), '1.0', true );
			wp_enqueue_style( 'nerf-customizer', get_template_directory_uri() . '/inc/customizer/css/customizer.css', array(), '1.1', 'all' );
			wp_enqueue_style( 'nerf-select2-css', get_template_directory_uri() . '/inc/customizer/css/select2.min.css', array(), '4.0.13', 'all' );
		}
		/**
		...
		public function to_json() {
			parent::to_json();
			$this->json['nerffontslist'] = $this->fontList;
		}
		/**
			...
			if( !empty($this->fontList) ) {
				...
				<div class="google_fonts_select_control">
					...
					<div class="google-fonts">
						<select class="google-fonts-list" control-name="<?php echo esc_attr( $this->id ); ?>" data-placeholder="<?php esc_attr_e('Choose a font', 'nerf'); ?>">
							<?php
					...
					<div class="customize-control-description"><?php esc_html_e( 'Select weight & style for regular text', 'nerf' ) ?></div>
					...
					<div class="customize-control-description"><?php esc_html_e( 'Font Subsets', 'nerf' ) ?></div>
					<div class="weight-style">
	 ...
	 */
	if ( ! function_exists( 'nerf_google_font_sanitization' ) ) {
		function nerf_google_font_sanitization( $input ) {
