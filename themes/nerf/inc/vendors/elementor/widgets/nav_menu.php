...
class Nerf_Elementor_Nav_Menu extends Widget_Base {
	...
	public function get_title() {
        return esc_html__( 'Apus Navigation Menu', 'nerf' );
    }
	...
	protected function register_controls() {
        ...
        $this->start_controls_section(
            'content_section',
            [
                'label' => esc_html__( 'Navigation Menu', 'nerf' ),
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => array(
                    ...
                    'st_circle' => esc_html__('Circle', 'nerf'),
                    'st_line' => esc_html__('Line', 'nerf'),
                ),
                'default' => ''
            ]
        );
        ...
        $this->start_controls_section(
            'section_menu_style',
            [
                'label' => esc_html__( 'Menu Item', 'nerf' ),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $this->add_control(
            'menu_color',
            [
                'label' => esc_html__( 'Menu Color', 'nerf' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'menu_color_hover',
            [
                'label' => esc_html__( 'Menu Color Hover', 'nerf' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    // Stronger selector to avoid section style from overwriting
                    '{{WRAPPER}} li:hover > a, 
        ...
        $this->add_group_control(
            Group_Control_Typography::get_type(),
            [
                'label' => esc_html__( 'Menu Typography', 'nerf' ),
...
if ( version_compare(ELEMENTOR_VERSION, '3.5.0', '<') ) {
    Plugin::instance()->widgets_manager->register_widget_type( new Nerf_Elementor_Nav_Menu );
} else {
    Plugin::instance()->widgets_manager->register( new Nerf_Elementor_Nav_Menu );
}