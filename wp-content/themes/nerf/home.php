...
?>
<section id="main-container" class="main-content home-page-default <?php echo apply_filters('nerf_blog_content_class', 'container');?> inner <?php echo esc_attr($checkcontent); ?>">
