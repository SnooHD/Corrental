...
class Nerf_Elementor_Social_Links extends Widget_Base {
	...
	public function get_title() {
        return esc_html__( 'Apus Social Links', 'nerf' );
    }
	...
	protected function register_controls() {
        ...
        $repeater->add_control(
            'title', [
                'label' => esc_html__( 'Social Title', 'nerf' ),
                'type' => Controls_Manager::TEXT,
                'default' => esc_html__( 'Social Title' , 'nerf' ),
                'label_block' => true,
            ]
        );
        ...
        $this->add_control(
            'social_icon_list',
            [
                'label' => esc_html__( 'Social Icons', 'nerf' ),
...
if ( version_compare(ELEMENTOR_VERSION, '3.5.0', '<') ) {
    Plugin::instance()->widgets_manager->register_widget_type( new Nerf_Elementor_Social_Links );
} else {
    Plugin::instance()->widgets_manager->register( new Nerf_Elementor_Social_Links );
}