...
class Nerf_Elementor_Team extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__( 'Apus Teams', 'nerf' );
    }
    ...
    protected function register_controls() {
        ...
        $repeater->add_control(
            'icon',
            [
                'label' => esc_html__( 'Social Icon', 'nerf' ),
        ...
        $repeater->add_control(
            'link',
            [
                'label' => esc_html__( 'Link Social', 'nerf' ),
        ...
        $this->add_control(
            'name', [
                'label' => esc_html__( 'Member Name', 'nerf' ),
                'type' => Controls_Manager::TEXT,
                'default' => esc_html__( 'Member Name' , 'nerf' ),
                'label_block' => true,
            ]
        );
        ...
        $this->add_control(
            'listing', [
                'label' => esc_html__( 'Member Job', 'nerf' ),
                'type' => Controls_Manager::TEXT,
                'default' => esc_html__( 'Member Listing' , 'nerf' ),
                'label_block' => true,
            ]
        );
        ...
        $this->add_control(
            'listing_color',
            [
                'label' => esc_html__( 'Listing Color', 'nerf' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                ...
                <div class="top-image">
                    ...
                    ?>
                        <div class="team-image">
                            <?php echo nerf_get_attachment_thumbnail($settings['img_src']['id'], 'full'); ?>
                        </div>
                    <?php } ?>
                </div>
                <ul class="social">
...
if ( version_compare(ELEMENTOR_VERSION, '3.5.0', '<') ) {
    Plugin::instance()->widgets_manager->register_widget_type( new Nerf_Elementor_Team );
} else {
    Plugin::instance()->widgets_manager->register( new Nerf_Elementor_Team );
}