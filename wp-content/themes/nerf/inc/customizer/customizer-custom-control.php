...
if ( class_exists( 'WP_Customize_Control' ) ) {
    class Nerf_WP_Customize_Radio_Image_Control extends WP_Customize_Control {
        public $type = 'nerf_radio_image';
    ...
    class Nerf_WP_Customize_Heading_Control extends WP_Customize_Control {
        public $type = 'nerf_heading';
