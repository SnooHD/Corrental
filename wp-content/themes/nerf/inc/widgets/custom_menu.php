...
class Nerf_Widget_Custom_Menu extends WP_Widget {
    public function __construct() {
        parent::__construct(
            'apus_custom_menu',
            esc_html__('Apus Custom Menu Widget', 'nerf'),
            array( 'description' => esc_html__( 'Show custom menu', 'nerf' ), )
        );
...
call_user_func( implode('_', array('register', 'widget') ), 'Nerf_Widget_Custom_Menu' );
